...
xcopy ..\KStaticFiles\public\Projects\JSONUser  public\JSONUser\  /s /e /Y
...
xcopy ..\KStaticFiles\src\public\JSONAdminApi  public\JSONAdminApi\  /s /e /Y
xcopy ..\KStaticFiles\src\public\JSONReports  public\JSONReports\  /s /e /Y
xcopy ..\KStaticFiles\src\public\JSONUser  public\JSONUser\  /s /e /Y
